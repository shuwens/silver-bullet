...
\newcommand{\outline}[1]{
  ...
  \noindent\begin{tabular}{@{}||p{.46\textwidth}} \textbf{Outline: } #1
\end{tabular}}}{}}
...
\newcommand{\todoF}[1]{\textsf{\textbf{\color{YellowOrange}{[#1]}}}}
...
\newcommand{\ts}[1]{\ifthenelse{\equal{\showcomments}{1}}{\todoF{Topic Sentence: #1}}{}}
