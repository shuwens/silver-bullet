...
\newcommand{\inprog}[1]{\ifthenelse{\equal{\showcomments}{1}}{{
      \color{ACMBlue}\vspace{.5em}%
      \noindent\begin{tabular}{@{}||p{.48\textwidth}} \textbf{In progress: } #1
\end{tabular}}}{}}
\newcommand{\outline}[1]{\ifthenelse{\equal{\showcomments}{1}}{{
      \color{VioletRed}\vspace{.5em}%\hspace*{.15em}
      \noindent\begin{tabular}{@{}||p{.48\textwidth}} \textbf{Outline: } #1
\end{tabular}}}{}}
...
\newcommand{\todoA}[1]{\textsf{\textbf{\color{Dandelion}{[#1]}}}}
\newcommand{\todoB}[1]{\textsf{\textbf{\color{Purple}{[#1]}}}}
...
\newcommand{\evan}[1]{\ifthenelse{\equal{\showcomments}{1}}{\todoA{Evan: #1}}{}}
\newcommand{\dave}[1]{\ifthenelse{\equal{\showcomments}{1}}{\todoC{Dave: #1}}{}}
\newcommand{\sun}[1]{\ifthenelse{\equal{\showcomments}{1}}{\todoE{Sun: #1}}{}}
...
\newcommand{\dummyfig}[1]{
  \centering
  \fbox{
    % \begin{minipage}[c][0.33\textheight][c]{.5\textwidth}
