...
\usepackage[abbreviate=false,backref=true,hyperref=true,giveninits=true,dateabbrev=true,isbn=false,doi=false,urldate=comp,url=false,maxbibnames=9,backend=biber,sorting=ynt,sortcites=true,language=american]{biblatex}
...
\hypersetup{colorlinks=true,urlcolor=violet,linkcolor=figurecolor,citecolor=citecolor,pdfstartview=FitH,backref=section,
  pdftitle={Understanding Performance Implications of Third-Party Network Functions},
...
% \newcommand*{\backrefalt}[4]{\ifcase #1 \or (\S #2). \else (\S #2). \fi}
